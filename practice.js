...
console.log(firstDivider);
let lastDivider = transmission.lastIndexOf("|")
console.log(lastDivider)
...
let codeName = transmission.slice(transmission.indexOf("|") + 1, transmission.lastIndexOf("|")).trim();
let clearanceCode = transmission.slice(transmission.lastIndexOf("|") + 1).trim();
